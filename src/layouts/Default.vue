<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-7">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/" @click.native="scrollToTop">
            <g-image src="../../static/Aaron-Jackson-logo.png" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/" @click.native="scrollToTop">
            <g-image src="../../static/Aaron-Jackson-alt-logo.png" class="w-40" alt="logo" />
          </g-link>
        </div>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="aaron.jcksn@outlook.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/aaron-jackson" target="_blank" class="text-white hover:text-gray-400">
          ...
          <!-- <li>
              <a href="https://twitter.com/aaronjcksn" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/aaronjcksn/" target="_blank" class="text-white hover:text-gray-400">
